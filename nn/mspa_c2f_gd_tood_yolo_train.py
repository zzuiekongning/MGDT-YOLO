...
print("************************start")
model = YOLO('/media/robot/7846E2E046E29DDE/paper_code_source/our_ultralytics/ultralytics/models/v8/mspa_c2f_gd_tood_yolov8.yaml')
print("************************")

model.load('/media/robot/7846E2E046E29DDE/ultralytics/runs/detect/using_mspa_c2f_gd/train/weights/best.pt')
